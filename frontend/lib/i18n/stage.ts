...
export const stageEnUS = {
  ...
  whiteboard: {
    ...
    readyHint: 'Write directly, or wait for AI to add elements',
  ...
  pbl: {
    ...
    roleSelection: {
      title: 'Choose a Role',
      description: 'Select a role to preview project collaboration',
    },
    workspace: {
      restart: 'Restart',
