export const chatZhCN = {
  ...
  agentBar: {
    readyToLearn: '您的 AI 教学团队已就位',
    expandedTitle: '课堂AI角色配置',
    configTooltip: '点击配置课堂AI角色',
    voiceLabel: '音色',
    voiceLoading: '加载中...',
...
export const chatEnUS = {
  ...
  agentBar: {
    readyToLearn: 'Your AI teaching team is ready',
    expandedTitle: 'Classroom AI Role Config',
    configTooltip: 'Click to configure classroom AI roles',
    voiceLabel: 'Voice',
