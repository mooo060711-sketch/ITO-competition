export const settingsZhCN = {
  settings: {
    ...
    testing: '测试中...',
    agentSettings: '智能体设置',
    agentSettingsDesc: '配置课堂中的AI角色。选择1个为单智能体授课模式，选择多个可模拟师生多角色互动场景。',
    agentMode: '智能体模式',
    agentModePreset: '预设模式',
    agentModeAuto: '自动生成',
    agentModeAutoDesc: 'AI 将根据您的教学思路和课程内容自动生成适合的课堂角色',
    autoAgentCount: '生成数量',
    ...
    enableASR: '启用语音识别',
    asrEnabledDescription: '开启后，可使用麦克风进行语音输入',
    ttsProvider: 'TTS 提供商',
  ...
  profile: {
    ...
    chooseAvatar: '选择头像',
    uploadAvatar: '上传',
    subjectPlaceholder: '学科，如：高中生物',
    gradePlaceholder: '年级',
    stylePlaceholder: '教学风格偏好，如：互动探究、讲练结合',
    bioPlaceholder: '补充说明，如特殊教学需求、学情特点等...',
    avatarHint: '您的头像将显示在课堂讨论和对话中',
    fileTooLarge: '图片过大，请选择小于 5MB 的图片',
    invalidFileType: '请选择图片文件',
    editTooltip: '点击完善教学档案，AI 将据此个性化生成课件',
  },
  media: {
...
export const settingsEnUS = {
  settings: {
    ...
    agentSettingsDesc:
      'Configure AI roles for the classroom. Select 1 for single-agent teaching mode, or multiple to simulate multi-role interactive scenarios.',
    agentMode: 'Agent Mode',
    agentModePreset: 'Preset',
    agentModeAuto: 'Auto-generate',
    agentModeAutoDesc: 'AI will auto-generate roles based on your teaching plan and course content',
    ...
    asrEnabledDescription: 'When enabled, microphone can be used for voice input',
  ...
  profile: {
    title: 'Profile',
    defaultNickname: 'Teacher',
    chooseAvatar: 'Choose Avatar',
    uploadAvatar: 'Upload',
    subjectPlaceholder: 'Subject, e.g. Biology',
    gradePlaceholder: 'Grade',
    stylePlaceholder: 'Teaching style, e.g. inquiry-based, lecture + practice',
    bioPlaceholder: 'Additional notes, e.g. special needs, student profile...',
    ...
    editTooltip: 'Set up your teaching profile — AI will personalize courseware for you',
  },
  media: {
