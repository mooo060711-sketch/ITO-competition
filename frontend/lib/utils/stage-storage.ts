...
export async function saveStageData(stageId: string, data: StageStoreData): Promise<void> {
  try {
    ...
    await db.stages.put({
      ...
      backendSessionId: data.stage.backendSessionId,
      backendVersionId: data.stage.backendVersionId,
      backendReferenceIndex: data.stage.backendReferenceIndex,
      backendReferenceIndexes: data.stage.backendReferenceIndexes,
      outputTypes: data.stage.outputTypes,
      backendArtifacts: data.stage.backendArtifacts,
      backendPlan: data.stage.backendPlan,
      backendErrors: data.stage.backendErrors,
      backendMissingArtifacts: data.stage.backendMissingArtifacts,
