...
export type InteractiveResourceKind = 'lesson_plan' | 'game' | 'animation';
...
export interface Stage {
  ...
  language?: string;
  style?: string;
  // Backend courseware session context (used for refine/version/export APIs)
  ...
  backendPlan?: BackendPlanData;
  backendErrors?: string[];
  backendMissingArtifacts?: BackendMissingArtifacts;
  // Whiteboard data
...
export interface InteractiveContent {
  ...
  artifactType?: 'docx' | 'game_html' | 'animation_html';
  versionId?: string;
}
