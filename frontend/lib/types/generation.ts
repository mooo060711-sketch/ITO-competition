...
export interface UserRequirements {
  ...
  userNickname?: string; // Teacher name for personalization
  userBio?: string; // Teacher background for personalization
  userSubject?: string; // Subject taught, e.g. "高中生物"
  userGradeLevel?: string; // Target grade level, e.g. "高一"
  userTeachingStyle?: string; // Teaching style preference, e.g. "互动探究"
